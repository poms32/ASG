        <!-- Header -->
        <header>
			<a href="/" class="logo"><i class="fa fa-bolt"></i> <span>ASG</span></a>
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <div class="pull-left"><img src="{{asset('img/avatar2.jpg')}}" class="img-rounded" alt="image"/></div>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left"><img src="{{asset('img/avatar.jpg')}}" class="img-rounded" alt="image"/></div>
										...
										<li>
                                            <a href="#">
                                                <div class="pull-left"><img src="{{asset('img/avatar3.jpg')}}" class="img-rounded" alt="image"/></div>
										...
										<li>
                                            <a href="#">
                                                <div class="pull-left"><img src="{{asset('img/avatar4.jpg')}}" class="img-rounded" alt="image"/></div>
                        ...
                        <li class="dropdown widget-user">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="{{asset('img/avatar.jpg')}}" class="pull-left" alt="image" />
